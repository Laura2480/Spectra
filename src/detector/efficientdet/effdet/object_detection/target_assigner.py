...
class TargetAssigner(object):
    ...
    def __init__(self, similarity_calc, matcher, box_coder, negative_class_weight=1.0, unmatched_cls_target=None):
        ...
        Args:
            ...
            negative_class_weight: classification weights to be associated to negative
                anchors (default: 1.0). The weights must be in [0., 1.].
    ...
    def assign(self, anchors, groundtruth_boxes, groundtruth_labels=None, groundtruth_weights=None, **params):
        ...
        Args:
            ...
            groundtruth_weights: a float tensor of shape [M] indicating the weights to
    ...
    def _default_regression_target(self, device):
        ...
        these targets are set to should not matter as the regression weights of any box
    ...
    def _create_regression_weights(self, match, groundtruth_weights):
        """Set regression weights for each anchor.

        Only positive anchors are set to contribute to the regression loss, so this
        method returns a weights of 1 for every positive anchor and 0 for every
        negative anchor.
    ...
    def _create_classification_weights(self, match, groundtruth_weights):
        ...
        Positive (matched) anchors are associated with a weights of
        positive_class_weight and negative (unmatched) anchors are associated with
        a weights of negative_class_weight. When anchors are ignored, weights are set
