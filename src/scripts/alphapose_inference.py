...
from utils.file_detector import FileDetectionLoader
from utils.transforms import flip, flip_heatmap
from utils.vis import getTime
from utils.webcam_detector import WebCamDetectionLoader
...
if __name__ == "__main__":
    ...
    if args.save_video and mode != 'image':
        from utils.writer import DEFAULT_VIDEO_SAVE_OPT as video_save_opt
        if mode == 'video':
