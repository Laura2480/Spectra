...
parser.add_argument('--videodir', dest='videopath',
                    help='image-directory', default="")
...
parser.add_argument('--convertH36', dest='convertH36',
                    help='convert keypoints to h36', action='store_true', default=False)
